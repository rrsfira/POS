...
const QuotationsTable = ({ data }) => {
  ...
  const handleExportExcel = () => {
    ...
    XLSX.writeFile(workbook, "Quotations Stock Report.xlsx");
  };
  ...
  const handleExportPDF = () => {
    ...
    doc.text("Data Quotations Stock Report", 14, yOffset);
    yOffset += 10;
    const tableColumn = [
      "Date",
      "Reference",
    ...
    doc.save("Quotations Stock Report.pdf");
  };
