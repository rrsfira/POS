...
const PurchasesReturn = ({ data }) => {
  ...
  const handleExportExcel = () => {
    ...
    XLSX.writeFile(workbook, "Purchases Return Stock Report.xlsx");
  };
  ...
  const handleExportPDF = () => {
    ...
    doc.text("Data Purchases Return Stock Report", 14, yOffset);
    yOffset += 10;
    const tableColumn = [
      "Date",
      "Reference",
    ...
    doc.save("Purchases Return Stock Report.pdf");
  };
